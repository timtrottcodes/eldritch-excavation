...
const GAME_DATA = {
    ...
    ores: [
        ...
        { id: 'starmetal', name: 'Star-Metal', description: 'Forged in the heart of dying suns...', baseValue: 190000000000, unlockAt: 2000000000000000, color: '#FFE4B5', textColor: '#1A1A1A', glowStrength: 2.02 },
        { id: 'darkmatter', name: 'Dark Matter Crystal', description: 'The universe\'s hidden mass made tangible...', baseValue: 450000000000, unlockAt: 5500000000000000, color: '#0D0D1F', textColor: '#FFFFFF', glowStrength: 2.60 },
        { id: 'timecrystal', name: 'Time Crystal', description: 'A pattern that repeats in time, not space...', baseValue: 1100000000000, unlockAt: 16000000000000000, color: '#00CED1', textColor: '#1A1A1A', glowStrength: 2.10 },
        { id: 'phase_matter', name: 'Phase Matter', description: 'Exists in multiple dimensions at once...', baseValue: 2600000000000, unlockAt: 45000000000000000, color: '#FF1493', textColor: '#FFFFFF', glowStrength: 2.30 },
        { id: 'reality_shard', name: 'Reality Shard', description: 'Fragments of broken universes...', baseValue: 6200000000000, unlockAt: 130000000000000000, color: '#FF6347', textColor: '#FFFFFF', glowStrength: 2.28 },
        { id: 'elder_essence', name: 'Elder Essence', description: 'The crystallized dreams of sleeping gods...', baseValue: 15000000000000, unlockAt: 370000000000000000, color: '#8B008B', textColor: '#FFFFFF', glowStrength: 2.80 },
        { id: 'azathoth_core', name: 'Azathoth\'s Core', description: 'The nuclear chaos at the center of infinity...', baseValue: 36000000000000, unlockAt: 1000000000000000000, color: '#4B0082', textColor: '#FFFFFF', glowStrength: 3.20 },
    ],
