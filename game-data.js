...
const GAME_DATA = {
    ...
    ores: [
        ...
        { id: 'copper', name: 'Copper Ore', description: 'Ancient civilizations forged their tools from this...', baseValue: 3, unlockAt: 500, color: '#B87333' },
        { id: 'zinc', name: 'Zinc Ore', description: 'A metal that whispers of corrosion...', baseValue: 8, unlockAt: 2500, color: '#C5C5C5' },
        { id: 'tin', name: 'Tin Ore', description: 'Soft and malleable, yet strangely resilient...', baseValue: 20, unlockAt: 10000, color: '#D4D4D4' },
        { id: 'lead', name: 'Lead Ore', description: 'Heavy with forgotten secrets...', baseValue: 50, unlockAt: 50000, color: '#6E6E6E' },
        { id: 'nickel', name: 'Nickel Ore', description: 'From meteorites that fell from beyond...', baseValue: 125, unlockAt: 250000, color: '#8C8C8C' },
        { id: 'aluminum', name: 'Aluminum Ore', description: 'Light as air, strong as will...', baseValue: 300, unlockAt: 1000000, color: '#D4D4D4' },

        // Precious Metals (Tier 8-14)
        { id: 'silver', name: 'Silver Ore', description: 'The moon\'s blessing upon the earth...', baseValue: 750, unlockAt: 5000000, color: '#C0C0C0' },
        { id: 'gold', name: 'Gold Ore', description: 'The sun incarnate, buried deep...', baseValue: 1800, unlockAt: 25000000, color: '#FFD700' },
        { id: 'platinum', name: 'Platinum Ore', description: 'Rarer than gold, colder than death...', baseValue: 4500, unlockAt: 100000000, color: '#E5E4E2' },
        { id: 'palladium', name: 'Palladium Ore', description: 'Lustrous white metal from the abyss...', baseValue: 11000, unlockAt: 500000000, color: '#CED0DD' },
        { id: 'rhodium', name: 'Rhodium Ore', description: 'The rarest of metals, gleaming with power...', baseValue: 27000, unlockAt: 2500000000, color: '#E8E8E8' },
        { id: 'iridium', name: 'Iridium Ore', description: 'Dense as a collapsed star...', baseValue: 65000, unlockAt: 10000000000, color: '#F0F0C0' },
        { id: 'osmium', name: 'Osmium Ore', description: 'The densest element, pulled from oblivion...', baseValue: 160000, unlockAt: 50000000000, color: '#A8A8A8' },

        // Gemstones (Tier 15-21)
        { id: 'garnet', name: 'Garnet Crystals', description: 'Deep red stones of ancient origin...', baseValue: 400000, unlockAt: 250000000000, color: '#AA2222' },
        { id: 'amethyst', name: 'Amethyst Crystals', description: 'Purple gems that channel cosmic energy...', baseValue: 950000, unlockAt: 1000000000000, color: '#9966CC' },
        { id: 'ruby', name: 'Ruby Crystals', description: 'Crimson as blood, hard as bone...', baseValue: 2300000, unlockAt: 5000000000000, color: '#E0115F' },
        { id: 'sapphire', name: 'Sapphire Crystals', description: 'Blue as the depths of madness...', baseValue: 5500000, unlockAt: 25000000000000, color: '#0F52BA' },
        { id: 'emerald', name: 'Emerald Crystals', description: 'Green with envy of the stars...', baseValue: 13000000, unlockAt: 100000000000000, color: '#50C878' },
        { id: 'diamond', name: 'Diamond Crystals', description: 'Compressed time itself...', baseValue: 32000000, unlockAt: 500000000000000, color: '#B9F2FF' },
        { id: 'alexandrite', name: 'Alexandrite', description: 'Changes color like reality shifts...', baseValue: 75000000, unlockAt: 2500000000000000, color: '#9370DB' },

        // Rare Minerals (Tier 22-28)
        { id: 'painite', name: 'Painite', description: 'One of Earth\'s rarest minerals...', baseValue: 180000000, unlockAt: 500000000000, color: '#CC5555' },
        { id: 'benitoite', name: 'Benitoite', description: 'Blue fire trapped in crystal form...', baseValue: 430000000, unlockAt: 1400000000000, color: '#4169E1' },
        { id: 'taaffeite', name: 'Taaffeite', description: 'So rare it was mistaken for another gem...', baseValue: 1000000000, unlockAt: 4000000000000, color: '#E6C7FF' },
        { id: 'meteorite', name: 'Meteorite Fragments', description: 'Fallen from beyond the stars...', baseValue: 2400000000, unlockAt: 11000000000000, color: '#4A4A4A' },
        { id: 'obsidian', name: 'Obsidian Shards', description: 'Volcanic glass from hell\'s furnace...', baseValue: 5800000000, unlockAt: 30000000000000, color: '#0B0B0B' },
        { id: 'moldavite', name: 'Moldavite', description: 'Born from cosmic impact...', baseValue: 14000000000, unlockAt: 85000000000000, color: '#3F7F3F' },
        { id: 'carborundum', name: 'Carborundum', description: 'Harder than nature intended...', baseValue: 33000000000, unlockAt: 240000000000000, color: '#5A5A8C' },

        // Eldritch Materials (Tier 29-35)
        { id: 'voidstone', name: 'Voidstone', description: 'A mineral that should not exist...', baseValue: 80000000000, unlockAt: 700000000000000, color: '#1a0033' },
        { id: 'starmetal', name: 'Star-Metal', description: 'Forged in the heart of dying suns...', baseValue: 190000000000, unlockAt: 2000000000000000, color: '#FFE4B5' },
        { id: 'darkmatter', name: 'Dark Matter Crystal', description: 'The universe\'s hidden mass made tangible...', baseValue: 450000000000, unlockAt: 5500000000000000, color: '#0D0D1F' },
        { id: 'timecrystal', name: 'Time Crystal', description: 'A pattern that repeats in time, not space...', baseValue: 1100000000000, unlockAt: 16000000000000000, color: '#00CED1' },
        { id: 'phase_matter', name: 'Phase Matter', description: 'Exists in multiple dimensions at once...', baseValue: 2600000000000, unlockAt: 45000000000000000, color: '#FF1493' },
        { id: 'reality_shard', name: 'Reality Shard', description: 'Fragments of broken universes...', baseValue: 6200000000000, unlockAt: 130000000000000000, color: '#FF6347' },
        { id: 'elder_essence', name: 'Elder Essence', description: 'The crystallized dreams of sleeping gods...', baseValue: 15000000000000, unlockAt: 370000000000000000, color: '#8B008B' },
        { id: 'azathoth_core', name: 'Azathoth\'s Core', description: 'The nuclear chaos at the center of infinity...', baseValue: 36000000000000, unlockAt: 1000000000000000000, color: '#4B0082' },
    ],
